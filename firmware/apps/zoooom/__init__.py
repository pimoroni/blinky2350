...
BRIGHTNESSES = (3, 6, 10, 13, 16, 19, 22, 26, 29, 32, 35, 38, 41, 45, 48, 51, 54, 57, 61, 64, 67, 70, 73, 76, 80, 83, 86, 89, 92, 96, 99, 102, 105, 108, 112, 115, 118, 121, 124, 128, 131, 134, 137, 140, 143, 147, 150, 153, 156, 159, 163, 166, 169, 172, 175, 178, 182, 185, 188, 191, 194, 198, 201, 204, 207, 210, 214, 217, 220, 223, 226, 230, 233, 236, 239, 242, 245, 249, 252, 255)
TEXTURE_SIZE = 64
...
def draw_wall(image, topleft, bottomleft, topright, bottomright, tex):
    ...
    for i in range(width):
        ...
        if x_pos > 0 and x_pos < screen_buffer.width:
            ...
            if x_pos >= 80:
                seg_brightness = BRIGHTNESSES[80 - (x_pos - 80)]
            else:
